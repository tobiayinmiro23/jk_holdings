...
const Analytics = () => {
    ...
    useEffect(() => {
        loaderTimer(setoverviewAnalyticsLoader, 1000)
        loaderTimer(setpropertiesForRentLoader, 1200)
        loaderTimer(setrevenueAnalyticsLoader, 800)
        loaderTimer(settenantsSummaryLoader, 1500)
    }, [])

    return (
        <div className={mobile && 'opacity-0'}>
            <div className='bg-[#f7f7f9] px-[2rem] max-[1226px]:px-[0.8rem]'>
