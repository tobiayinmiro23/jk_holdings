            ...
            <div className=' w-[97%] bg-[white] m-[auto] mt-[2rem] py-[1.65rem] px-[2.1rem] pb-[2rem] rounded-md max-[490px]:px-[1.3rem] max-[340px]:px-[0.7rem]'>
                ...
                <div className='mb-[2.2rem]'>
                    ...
                    <div className='w-[100%] bg-[#f7f7f9] py-[3.4rem] rounded-md'>
                        <div className='border-[3px] w-[50%]  m-[auto] rounded-lg border-dashed border-[#a3a1a1]'>
                            <div className='flex items-center justify-center py-[0.5rem]' >
                                <div className='w-[1.1rem]  h-[1.1rem] mr-[0.4rem]'><img src="/image/user.png" alt="" /></div>
                                <p>Choose Files</p>
                            </div>
                        </div>
                    </div>
                ...
                <div className='flex items-center justify-end'>
                    <button className='bg-[darkblue] text-white rounded-md py-[0.6rem] px-[1.2rem] text-[1rem]'>Add Property</button>
