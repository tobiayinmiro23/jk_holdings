            ...
            <div className='w-[100%] px-[2rem] pb-[0rem] pt-[0.6rem] bg-[white] border-[#eae9e9] border-[1px] rounded-lg max-[817px]:px-[0.66rem]'>
                ...
                <div className='flex items-center justify-between mb-[-1.4rem]'>
                    <div className='flex items-center'>
                        <div className='mr-[0.6rem]  bg-orange-400 rounded-lg max-[817px]:mr-[0.3rem]'><MapsHomeWorkOutlinedIcon className='m-[0.7rem] text-white max-[397px]:m-[0.5rem] max-[344px]:m-[0.39rem] max-[329px]:m-[0.28rem] ' /></div>
                        <div>
                            <p className='text-[#534f4fe3] max-[817px]:text-[0.87rem] max-[334px]:text-[0.8rem]'>Total unit</p>
