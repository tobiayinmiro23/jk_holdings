...
const AllTenants = () => {
    ...
    return (
        <div className='bg-white px-[1.3rem] w-[100%] m-[auto]  max-[883px]:px-[0.6rem] max-[849px]:px-0 max-[651px]:overflow-scroll max-[651px]:px-[0rem] max-[651px]:w-[100%]'>
            <table className='max-[651px]:w-[50rem]'>
                <thead className=' '>
                    <tr className='text-start border-[1px] border-[lightgray]'>
                        {tenantHeading.map(item => {
                            return <th className=' py-[0.75rem] pl-[0.75rem]'>
