...
const Card2 = () => {
    ...
    return (
        <div className=' flex items-center justify-center flex-wrap my-[1rem]'>
            {
                cardData.map(item => {
                    return <div className='border-[1px] rounded-md border-[lightgray] bg-white w-[fit-content] mx-[1rem] my-[1rem] max-[1249px]:w-[30%] max-[1249px]:mx-[1%] max-[699px]:w-[45%] max-[699px]:mx-[2%] max-[495px]:w-[48%] max-[495px]:mx-[1%]'>
