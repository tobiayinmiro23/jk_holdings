    ...
    return (
        <header className='flex items-center justify-between py-[1rem] px-[1.2rem] max-[398px]:px-[0.7rem] '>
            ...
            <div className='flex items-center'>
                <div className='rounded-full  w-[1.8rem]  p-[2px] bg-[lightgray]  h-[1.9rem]'>
                ...
                <div className='rounded-full w-[2.07rem] ml-[1.7rem] p-[5px] cursor-pointer bg-[lightgray] h-[2.37rem] max-[472px]:ml-[1.4rem] max-[425px]:ml-[1.2rem] max-[398px]:w-[1.8rem] max-[398px]:h-[2.07rem] max-[398px]:p-[3px] max-[398px]:ml-[0.68rem]'><img className='rounded-full' src="/image/7.jpeg" alt="" /></div>
